...
def load_data():
    ...
    data1 = pd.read_csv("data/source/application_train.csv", usecols=important_features+['TARGET','SK_ID_CURR'])
    data2 = pd.read_csv("data/source/application_test.csv",  usecols= important_features+['SK_ID_CURR'] )
